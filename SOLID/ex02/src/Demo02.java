    ...
    // Ye demo dependency injection ka example hai jahan different tax/discount rules pass karke same system ko reuse kiya gaya hai, so behavior change hota hai bina core class modify kiye (clean SRP + flexibility)
...
public class CafeteriaSystem 
{
    ...
    public void checkout(List<OrderLine> lines) 
    {
        ...
        double tax = taxRules.calcTax(subtotal);

        double discount = discountRules.calcDisc(subtotal, lines.size());
...
// Ye class ab sirf orchestration handle karti hai (menu lookup + rules call + formatting + persistence), isliye har concern alag component me shift ho gaya hai and SRP properly follow ho raha hai